...
3. Browser checks: run at least one browser flow that exercises changed UX paths, per [AGENTS.md](../../../AGENTS.md#quality-gates)'s mandatory external fullscreen Chromium-family browser verification.
