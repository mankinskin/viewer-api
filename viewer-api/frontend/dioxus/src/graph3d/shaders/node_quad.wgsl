...
fn vs_node_quad(
    ...
    let pixel_scale = clamp(22.0 / dist, 0.14, 3.5);

    // Slightly oversized to fully cover the DOM card (260×~70 px base).
    let card_w = 220.0 * pixel_scale;
    let card_h = 70.0  * pixel_scale;
