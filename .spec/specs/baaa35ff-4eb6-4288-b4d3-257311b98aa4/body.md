...
Canonical specification for the shared client-side store helpers under `viewer-api/frontend/dioxus/src/store/` — the localStorage-backed signal helpers reused by every viewer (theme, layout, settings, last-opened ids).
