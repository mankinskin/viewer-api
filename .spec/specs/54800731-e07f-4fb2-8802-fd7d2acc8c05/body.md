...
Canonical specification for `viewer-api::sse` — the server-sent-events helper used by every viewer that pushes live data (log tail, ticket board events, spec changes).
