...
Canonical specification for the `viewer-api::auth`, `viewer-api::middleware`, and `viewer-api::error` modules — the security and error-translation stack used by every viewer.
