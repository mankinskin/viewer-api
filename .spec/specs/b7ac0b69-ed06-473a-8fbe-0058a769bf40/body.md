...
`viewer-ctl` is the **lifecycle manager** for context-engine viewer servers, their frontends, and the VS Code extensions that ship alongside them. It is a single Rust binary, driven entirely by a TOML registry at the repository root.
