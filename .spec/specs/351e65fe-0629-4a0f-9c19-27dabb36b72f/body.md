...
Servers are long-running Rust binaries that bind a TCP port. viewer-ctl owns their build, install, start, and stop steps; once started, the server is no longer supervised.
