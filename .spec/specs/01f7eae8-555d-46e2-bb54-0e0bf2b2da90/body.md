...
A task is an ordered list of shell command invocations. Tasks are the escape hatch for repeatable multi-step pipelines that don't fit the build/install/start verbs of any single component (e.g. type generation).
