...
Canonical specification for the shared code/file display Dioxus components (`viewer-api/frontend/dioxus/src/components/code_viewer.rs` and `file_content_viewer.rs`).
