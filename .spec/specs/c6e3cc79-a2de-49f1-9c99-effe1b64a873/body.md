...
Canonical specification for `viewer-api::client_log` — the server endpoint that receives structured log events from WASM frontends and writes them to the same tracing pipeline as backend logs.
